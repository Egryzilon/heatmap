    ...
    <div className="w-screen h-screen absolute top-0 left-0">
      <header className='bg-[#141956]'>
        ...
        <div className="bg-[#0B0F3B] relative flex p-1">
          <img src="https://www.svgrepo.com/show/521826/search.svg" alt="Lupa" width={30} className='absolute left-5 top-1/2 -translate-y-1/2 opacity-50' />
          <input className="bg-white rounded-sm w-1/3 pl-15 py-3 border"
